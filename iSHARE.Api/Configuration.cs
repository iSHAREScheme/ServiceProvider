...
namespace iSHARE.Api
{
    public static class Configuration
    {
        ...
        public static IServiceCollection AddErrorDetailsHandler(this IServiceCollection services, IConfiguration configuration)
        {
            services.Configure<ErrorDetailsOptions>(configuration.GetSection("ErrorDetails"));
            return services;
        }
